...
[idbbee src="//thyme.dbbee.com/u/demo/" width="100%" height="500"] shortcode
...
WordPress removes certain html tags because of security reasons, among them `<iframe>` and `<script>`.
idbbee shortcode is used for embedding dbBee projects to your WordPress page or post as iframe element.
